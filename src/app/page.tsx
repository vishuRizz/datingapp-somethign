    ...
    <>
      ...
      <div className="relative py-10">
        ...
        <div className="relative max-w-none overflow-hidden">
          <svg className="block w-[1600px] h-[160px] mx-auto opacity-95" viewBox="0 0 1600 160" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="limeSoft" x1="0" x2="0" y1="1" y2="0">
                <stop offset="0%" stopColor="#4fae1a" />
                <stop offset="50%" stopColor="#a6f36a" />
            ...
            <text fill="url(#limeSoft)" fontSize="64" fontWeight="700" opacity="0.5" letterSpacing="3" fontFamily="system-ui, -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, 'Helvetica Neue', Arial">
